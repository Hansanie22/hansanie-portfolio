  ...
  try {
    ...
    return [
      ...
      },
      {
        id: 2,
        code: 'velora-pos',
        title: 'VELORA / RUSH JEWELS — Enterprise Fine Jewellery E-Commerce & Retail POS Suite',
        category: 'Enterprise Java 17, Spring Boot 3 & Touch POS',
        tagLine: 'Multi-tenant Retail Point-of-Sale Terminal, Barcode Scanning, Multi-Warehouse Inventory & Docker Cloud Deployment',
        overview: 'A comprehensive Enterprise Retail POS & Luxury Fine Jewellery management suite engineered with Spring Boot 3, featuring touch terminal billing, split cash/card payments, barcode scanner lookup, dynamic metal pricing matrices, and cashier shift reconciliation.',
        ...
        liveDemoUrl: 'https://www.rushjewels.com',
        githubUrl: 'https://github.com/Hansanie22/Rush-Jewels-Enterprise-POS',
        swaggerUrl: 'https://www.rushjewels.com/swagger-ui.html',
      ...
      },
      {
        id: 3,
        code: 'auracraft-erp',
        title: 'AURACRAFT / CEYLON LETTER CO — Bespoke Keepsakes ERP & Automation Suite',
        category: 'Cloud ERP, Webhooks & Automated Manufacturing Workflow',
        tagLine: 'Real-time Spring Cron Webhook Synchronization, Automated Bill-of-Materials Deduction & Interactive Video Commerce',
        overview: 'A custom manufacturing ERP and luxury bespoke gifts e-commerce platform featuring automated packaging inventory deduction engines, Spring Cron-scheduled Cloud Webhooks, and interactive luxury video-commerce tag overlays.',
        ...
        liveDemoUrl: 'https://www.ceylonletterco.com',
        githubUrl: 'https://github.com/Hansanie22/AuraCraft-ERP-Suite',
        swaggerUrl: 'https://www.ceylonletterco.com/swagger-ui.html',
